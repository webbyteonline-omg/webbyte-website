        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-2xl font-extrabold text-gray-900">
              Web<span className="text-purple-600">Byte</span> Admin
            </h1>
              ...
              <tbody className="divide-y divide-gray-50">
                {filtered.map(order => (
                  <tr key={order.id} className="hover:bg-gray-50">
                    <td className="px-4 py-4 font-mono text-xs text-purple-700 font-semibold">#{order.orderNumber}</td>
                    ...
                    <td className="px-4 py-4 font-bold text-gray-900">₹{order.productPrice.toLocaleString('en-IN')}</td>
                    <td className="px-4 py-4">
                    ...
                    <td className="px-4 py-4">
                      <select
                        ...
                        className="text-xs border border-gray-200 rounded-lg px-2 py-1.5 bg-white focus:outline-none focus:ring-1 focus:ring-purple-500"
                      >
